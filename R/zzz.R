.onAttach <- function(libname, pkgname) {
      ...
      packageStartupMessage(" Blackmon, H., Justison, J., Mayrose, I. and Goldberg, E.E. (2019).") 
      packageStartupMessage(" Meiotic drive shapes rates of karyotype evolution in mammals.") 
      packageStartupMessage(" Evolution, 73(3), pp.511-523. \n")
    }
